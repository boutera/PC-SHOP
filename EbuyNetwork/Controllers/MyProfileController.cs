...
namespace EbuyNetwork.Controllers
{
    public class MyProfileController : Controller
    {
        ...
        // POST : MyProfile
        [HttpPost]
        public ActionResult Index(string editRequest, string firstname, string lastname, string password, string address, string CIN)
        {
            ...
            q1.CommandText = "UPDATE [User] SET password='" + password + "',firstname='" + firstname + "',lastname='" + lastname + "',address='" + address + "',CIN='" + CIN + "' WHERE id='"+luser.id+"'";
            q1.ExecuteNonQuery();
