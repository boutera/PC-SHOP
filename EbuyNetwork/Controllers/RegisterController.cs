...
namespace EbuyNetwork.Controllers
{
    public class RegisterController : Controller
    {
        ...
        // POST : Register
        [HttpPost]
        public ActionResult Index(string registerRequest, string firstname,string lastname,string emailaddress,string password, string address,string CIN)
        {
            ...
            else
            {
                ...
                q1.CommandText = "INSERT INTO [User](email,password,firstname,lastname,address,CIN) VALUES('" + emailaddress + "','" + password + "','" + firstname + "','" + lastname + "','" + address + "','"+CIN+"');";
