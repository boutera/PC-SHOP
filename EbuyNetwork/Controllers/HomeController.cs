...
namespace EbuyNetwork.Models
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            q.CommandType = CommandType.Text;
            q.CommandText = "SELECT TOP 8 [Category].name AS category_name, [Category].item_count AS category_item_count,[Item].* FROM [Item] LEFT JOIN [Category] ON [Item].category_id=[Category].id ORDER BY [Item].id DESC";
